(function($){
	jQuery(document).ready(function(){
		...
		function resp(){
			jQuery('.portfolio .item').css('height',portItemHeigt*2/3*jQuery('.portfolio').parent().width()/1000);
			jQuery('.portfolio .item div img').css('width',portImWidth*2/3*jQuery('.portfolio').parent().width()/1000);
			jQuery('.portfolio .item div img').css('height',portImHeigt*2/3*jQuery('.portfolio').parent().width()/1000);
			jQuery('.portfolio').css('height',portDivHeigt*2/3*jQuery('.portfolio').parent().width()/1000);
			jQuery('.TSIC').css('font-size',TSICWidth*jQuery('.portfolio').parent().width()/1000);
			jQuery('.portIcLeft').css('left',60*jQuery('.portfolio').parent().width()/1000);
			jQuery('.portIcRight').css('right',60*jQuery('.portfolio').parent().width()/1000);
		}
		resp();
    ...
    $.fn.portfolio = function(options) {
		...
		var d = {
				...
				path: {
					width: TotalSoftPortfolio_NavS*jQuery('.portfolio').parent().width()/1000,
					height: TotalSoftPortfolio_NavS*jQuery('.portfolio').parent().width()/1000,
					marginTop: 5*jQuery('.portfolio').parent().width()/1000,
					marginLeft: 5*jQuery('.portfolio').parent().width()/1000
				},
				animationSpeed: 400
		}; // default settings
