...
if(!class_exists('AIO_Icon_Manager'))
{
	class AIO_Icon_Manager
	{
		...
		function __construct()
		{
			...
			if ( function_exists('add_shortcode_param'))
			{
				add_shortcode_param('chk-switch' , array($this, 'checkboxes_param')) ;
			}		
		}
...
';
		...
		?>
            <div class="wrap">
            <h2>
            <?php _e('Icon Fonts Manager','smile'); ?>
            ...
            <?php	self::get_font_set();	?>
                        ...
                        <div class="error">
                          <p>
                            <?php _e('No font icons uploaded. Upload some font icons to display here.','smile');?>
            </p>
            </div>
            <?php
			endif;
