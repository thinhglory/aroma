...
add_filter( 'excerpt_more', 'new_excerpt_more' );
 ...
 while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
     <div class="col-md-6 ctn_menu">
         <h3><a href="<?php the_permalink() ?>" rel="bookmark"
                title="<?php _e('Learn more about: ', 'restaurant-menu-manager'); ?><?php the_title_attribute(); ?>"><?php the_title(); ?></a>
             <div class="price-text-menu">
                 <?php
                     echo '$';
                     echo display_entry_price();
                 ?>
             </div>
         </h3>
         <!--<div class="menu-entry-meta"><span class="price-text"><?php /*_e('Price:', 'restaurant-menu-manager'); */?></span>
